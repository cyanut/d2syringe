protdic={'C': {'BNLS': {0: {'args': [],
                ...
                2: {'args': [['STRING', 'Account name'],
                    ...
                    'type': 'BNLS'},
                3: {'args': [['DWORD[16]',
                              'Data from SID_AUTH_ACCOUNTLOGON']],
                    'id': 3,
                    'name': 'LOGONPROOF',
                ...
                5: {'args': [['STRING', 'Account name'],
                    ...
                    'type': 'BNLS'},
                6: {'args': [['DWORD[16]',
                              'Data from SID_AUTH_ACCOUNTCHANGE (0x55)']],
                    'id': 6,
                    'name': 'CHANGEPROOF',
                ...
                9: {'args': [['DWORD', 'Product ID'],
                    ...
                    'type': 'BNLS'},
                10: {'args': [['DWORD[5]',
                               'Password proof from Battle.net']],
                     'id': 10,
                     'name': 'CONFIRMLOGON',
                ...
                19: {'args': [['DWORD', 'Slot index'],
                              ...
                              ['DWORD[8]',
                               "Data client's SID_AUTH_ACCOUNTLOGON (0x53) request"]],
                     'id': 19,
                ...
                20: {'args': [['DWORD', 'Slot index'],
                              ['DWORD[5]',
                               "Data from client's SID_AUTH_ACCOUNTLOGONPROOF (0x54)"],
 ...
 'S': {'BNLS': {1: {'args': [['BOOLEAN', 'Result'],
                             ...
                             ['DWORD', 'Unknown (0)'],
                             ['DWORD[5]',
                              'CD-Key Hash* (CDKey data for SID_AUTH_CHECK)']],
                    'id': 1,
                    'name': 'CDKEY',
                    ...
                    'type': 'BNLS'},
                2: {'args': [['DWORD[8]',
                              'Data for SID_AUTH_ACCOUNTLOGON']],
                    'id': 2,
                    'name': 'LOGONCHALLENGE',
                    ...
                    'type': 'BNLS'},
                3: {'args': [['DWORD[5]',
                              'Data for SID_AUTH_ACCOUNTLOGONPROOF']],
                    'id': 3,
                    'name': 'LOGONPROOF',
                    ...
                    'type': 'BNLS'},
                4: {'args': [['DWORD[16]',
                              'Data for Data for SID_AUTH_ACCOUNTCREATE (0x52)']],
                    'id': 4,
                    'name': 'CREATEACCOUNT',
                    ...
                    'type': 'BNLS'},
                5: {'args': [['DWORD[8]',
                              'Data for SID_AUTH_ACCOUNTCHANGE (0x55)']],
                    'id': 5,
                    'name': 'CHANGECHALLENGE',
                    ...
                    'type': 'BNLS'},
                6: {'args': [['DWORD[21]',
                              'Data for SID_AUTH_ACCOUNTCHANGEPROOF (0x56)']],
                    'id': 6,
                    'name': 'CHANGEPROOF',
                ...
                7: {'args': [['BOOLEAN', 'Success code']],
                    ...
                    'type': 'BNLS'},
                8: {'args': [['DWORD[22]',
                              'Data for SID_AUTH_ACCOUNTUPGRADEPROOF (0x58)']],
                    'id': 8,
                    'name': 'UPGRADEPROOF',
                ...
                19: {'args': [['DWORD', 'Slot index'],
                              ['DWORD[16]',
                               "Data for the server's SID_AUTH_ACCOUNTLOGON (0x53) response"]],
                     'id': 19,
                     'name': 'SERVERLOGONCHALLENGE',
                ...
                20: {'args': [['DWORD', 'Slot index'],
                              ...
                              ['DWORD[5]',
                               "Data for server's SID_AUTH_ACCOUNTLOGONPROOF (0x54) response."]],
                     'id': 20,
                     'name': 'SERVERLOGONPROOF',
       ...
       'D2GS': { 0: {'args': [],
                 ...
                 1: {'args': [],
                     'id': 1,
                     'name': 'PINGREQUEST',
                     'remark': "game flag, client sends ping",
                     'source': 'S',
                     'type': 'D2GS'},     
                 2: {'args': [],
                     'id': 2
                     'name': 'LOADED',
                     'remark': "The game finished loading, client should join the game",
                     'source': 'S',
                     'type': 'D2GS'},
                 3: {'args': [['BYTE', 'act type'],
                              ['DWORD', 'map id'],
                              ['WORD', 'area id']],
                     'id': 3,
                     'name': 'LOADACT',
                 ...
                 0x0f: {'args': ['BYTE', 'Unknown'],
                     ...
                     'id': 15,
                     'name': 'PLAYERMOVING',
                     'remark': "another player is moving",
                     'source': 'S',
                     'type': 'D2GS'},
               ...
               0x15: {'args': ['BYTE', 'Unknown'],
                              ['DWORD', 'player id'],
                              ['WORD', 'X coordinate'],
                              ['WORD', 'Y Coordinate']],
                     'id': 0x15,
                     'name': 'PLAYERREASSIGN',
                     'remark': "player reassign to location, happens occasionally",
                     'source': 'S',
                     'type': 'D2GS'},
               
               
               0x18: {'args': ['BYTE', 'Unknown'],
                              ['WORD', 'life, bitwise and with 0x7fff'],
                              ['WORD', 'mana?']],
                              
                     'id': 0x18,
                     'name': 'LIFEMANA',
                     'remark': "change life/mana",
                     'source': 'S',
                     'type': 'D2GS'},
               ...
               0x1a: {'args': ['BYTE', 'Experience']],
                     'id': 0x1a,
                     'name': 'EXPGAIN_BYTE',
                     'remark': "gain experience",
                     'source': 'S',
                     'type': 'D2GS'},
                
               0x1b: {'args': ['WORD', 'Experience']],
                     'id': 0x1b,
                     'name': 'EXPGAIN_WORD',
                     'remark': "gain experience",
                     'source': 'S',
                     'type': 'D2GS'},
               0x1c: {'args': ['DWORD', 'Experience']],
                     'id': 0x1c,
                     'name': 'EXPGAIN_DWORD',
                     'remark': "gain experience",
                     'source': 'S',
               ...
               0x22: {'args': ['BYTE', 'Unknown'],
                              ['WORD', 'Unknown'],
                              ['DWORD', 'Unknown'],
                              ['WORD', 'Skill id'],
                              ['BYTE', 'skill bonus amount']],
                     'id': 0x22,
                     'name': 'SKILLBONUS',
                     'remark': "received an item skill level bonus from something currently equipped",
                     'source': 'S',
                     'type': 'D2GS'},
               ...
               0x27: {'args': ['BYTE', 'Unknown'],
                              ['DWORD', 'NPC id'],
                     'id': 0x27,
                     'name': 'NPCCHATMSG',
                     'remark': "initiate chat by sending 0x2f",
                     'source': 'S',
                     'type': 'D2GS'},
                     'type': 'D2GS'},
                81: {'args': [['BYTE',
...
#                    'source': 'S',
#                    'type': 'D2GS'},
               0x5c: {'args': ['DWORD', 'player left']],
                     'id': 0x5c,
                     'name': 'PLAYERLEFT',
                     'remark': "a player left game",
                     'source': 'S',
                     'type': 'D2GS'},
               0x59: {'args': ['DWORD', 'player id'],
                              ['BYTE', 'character class type'],
                              ['CHAR[16]', 'player name'],
                              ['WORD', 'X coordinate'],
                              ['WORD', 'Y coordinate']],
                     'id': 0x59,
                     'name': 'INITASGN',
                     'remark': "initial player assignment",
                     'source': 'S',
                    'type': 'D2GS'},
               0x67: {'args': ['DWORD', 'npc id'],
                              ['BYTE', 'movement type'],
                              ['WORD', 'X coordinate'],
                              ['WORD', 'Y coordinate']],
                     'id': 0x67,
                     'name': 'NPCMOVE',
                     'remark': "npc move to location. movetype 0x17=running, 0x01=walking",
                     'source': 'S',
                    'type': 'D2GS'},
               0x68: {'args': ['DWORD', 'npc id'],
                              ['BYTE', 'movement type'],
                              ['WORD', 'X coordinate'],
                              ['WORD', 'Y coordinate']],
                     'id': 0x68,
                     'name': 'NPCMOVEENTITY',
                     'remark': "npc move to entity. movetype 0x18=running, 0x00=walking",
                     'source': 'S',
                    'type': 'D2GS'},

               0x6d: {'args': ['DWORD', 'npc id'],
                              ['WORD', 'X coordinate'],
                              ['WORD', 'Y coordinate'],
                              ['BYTE', 'life?']],
                     'id': 0x6d,
                     'name': 'NPCSTOPMOVE',
                     'remark': "npc stopped moving",
                     'source': 'S',
                    'type': 'D2GS'},
               ...
               0x81: {'args': ['BYTE', 'unknown'],
                              ['WORD', 'unknown'],
                              ['DWORD', 'owner id'],
                              ['DWORD', 'mercenary id']],
                     'id': 0x81,
                     'name': 'MERCUNKNOWN',
                     'remark': "something about merc",
                     'source': 'S',
                    'type': 'D2GS'},
                ...
                0x8f:{'args': [],
                      'id': 0x8f,
                      'name': 'PONG',
                      'remark': "server respond to ping",
                      'source': 'S',
                      'type': 'D2GS'},
                0x94:{'args': [['BYTE', 'skill count'],
                               ['DWORD', 'unknown'],
                               ['LIST[$1]', [["WORD", 'skill id'],
                                             ["BYTE", 'skill level']]]],
                      'id': 0x94,
                      'name': 'BASESKILL',
                      'remark': "all the base skills",
                      'source': 'S',
                      'type': 'D2GS'},     
                
               0x95: {'args': ['BYTE', 'Unknown'],
                              ['WORD', 'life, bitwise and with 0x7fff'],
                              ['WORD', 'mana?']],
                     ...
                     'source': 'S',
                     'type': 'D2GS'},
                0x9c:{'args': [['BYTE[]', 'iteminfo']],
                      'id': 0x9c,
                      'name': 'ITEMINFO1',
                      'remark': "iteminfo",
                      'source': 'S',
                      'type': 'D2GS'},    
                0x9d:{'args': [['BYTE[]', 'iteminfo']],
                      'id': 0x9d,
                      'name': 'ITEMINFO2',
                      'remark': "iteminfo",
                      'source': 'S',
                      'type': 'D2GS'},   
                0xac:{'args': [['BYTE[]', 'npcinfo']],
                      'id': 0xac,
                      'name': 'NPCINFO',
                      'remark': "npc info",
                      'source': 'S',
       ...
       'SID': {0: {'args': [],
               ...
               9: {'args': [['DWORD', 'Number of games'],
                            ...
                            ['BYTE[8]',
                             "Host counter (characters representing reversed hexadecimal number, ex: '20000000' for second time this host has hosted during his session)"],
               ...
               86: {'args': [['DWORD', 'Status code'],
                             ['BYTE[20]',
                              'Server password proof for old password (M2)']],
                    'id': 86,
                    'name': 'AUTH',
